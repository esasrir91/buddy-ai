...
class TimezoneTools(Toolkit):
    ...
    def convert_timezone(
        self, datetime_str: str, from_timezone: str, to_timezone: str, format: str = "%Y-%m-%d %H:%M:%S"
    ) -> str:
    ...
    def list_timezones(self, filter_text: Optional[str] = None) -> str:
        ...
        try:
            ...
            if filter_text:
                filtered_timezones = [tz for tz in all_timezones if filter_text.lower() in tz.lower()]
    ...
    def calculate_time_difference(
        self, datetime1: str, timezone1: str, datetime2: str, timezone2: str, format: str = "%Y-%m-%d %H:%M:%S"
    ) -> str:
        ...
        try:
            ...
            return json.dumps(
                {
                    "datetime1": {"datetime": datetime1, "timezone": timezone1, "iso": localized_dt1.isoformat()},
                    "datetime2": {"datetime": datetime2, "timezone": timezone2, "iso": localized_dt2.isoformat()},
                    "difference": {
