...
class SeleniumTools(Toolkit):
    ...
    def navigate_to(self, url: str) -> str:
        ...
        try:
            ...
            return json.dumps(
                {"status": "success", "message": f"Navigated to {url}", "title": title, "current_url": current_url}
            )
    ...
    def select_dropdown_option(
        self, locator_type: str, locator_value: str, option_value: str, by_value: bool = True
    ) -> str:
    ...
    def drag_and_drop(
        self, source_locator_type: str, source_locator_value: str, target_locator_type: str, target_locator_value: str
    ) -> str:
