...
def train(
    ...
    model: Optional[str] = typer.Option(
        ...
        "--model",
        "-m",
        help="Base model (use aliases like 'mistral-7b', 'llama3-8b', 'phi-2' or full HuggingFace IDs)",
    ),
...
def install_deps():
    ...
    packages = ["transformers>=4.20.0", "torch>=1.12.0", "datasets>=2.0.0", "accelerate>=0.20.0"]
