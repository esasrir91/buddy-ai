...
class BuddyTrainedModel(Model):
    ...
    def parse_provider_response(self, response: Any, **kwargs) -> ModelResponse:
        ...
        return ModelResponse(content=generated_text.strip(), role="assistant")
...
def create_trained_model(
    model_path: str, model_name: str = "My Trained Model", **generation_params
) -> BuddyTrainedModel:
    """
    ...
    """
    return BuddyTrainedModel(name=model_name, model_path=model_path, **generation_params)
