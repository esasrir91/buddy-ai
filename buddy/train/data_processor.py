...
class DataProcessor:
    ...
    def process_directory(self, directory_path: str) -> ProcessedData:
        ...
        return ProcessedData(texts=all_texts, metadata=all_metadata, stats=stats)
    ...
    def load_processed_data(self, file_path: str) -> ProcessedData:
        ...
        return ProcessedData(texts=data["texts"], metadata=data["metadata"], stats=data.get("stats", {}))
