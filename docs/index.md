...
!!! tip "New in v2.1.0 — PULSE"
    **PULSE (Virtual Employee's ERA)** is the flagship new feature: an AI agent that operates exactly like a human employee — with an identity, interactive knowledge transfer, meeting intelligence, task management, and a full web UI. [Learn more →](advanced/pulse.md)
...
| **[PULSE](advanced/pulse.md)** | Virtual employee | Identity, KT, meetings, tasks, web UI |
